...
export const PDFViewer = ({
  ...
  const [annotations, setAnnotations] = useAnnotations(paper)
  ...
  const [operationType, setOperationType] = useState<OperationType>(OperationType.Notes)
  ...
  return (
    <Worker workerUrl="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.4.120/pdf.worker.min.js">
      <div className='flex flex-col h-[calc(100vh-6rem)] w-full'>
        <div className='h-12 flex items-center justify-between bg-white border-b gap-x-20'>
          <Tooltip
        ...
        <div className='h-[calc(100vh-9rem)] flex overflow-auto'>
          <div
            style={{
              overflow: 'auto',
